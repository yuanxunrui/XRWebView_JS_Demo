...
-(void)buttonClick{
    ...
    [self.webView evaluateJavaScript:@"navButtonAction('yuanxr',25)" completionHandler:^(id _Nullable response, NSError * _Nullable error) {
...
-(void)webView:(WKWebView *)webView didFinishNavigation:(WKNavigation *)navigation{
    ...
    NSString *js2 = @"document.getElementsByTagName('h1')[0].innerText = '测试iOS自己改的'";
    
    //执行JS
    [webView evaluateJavaScript:js2 completionHandler:^(id _Nullable response, NSError * _Nullable error) {
